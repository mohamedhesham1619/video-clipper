    ...
    sides: [
        ...
        },
        {
            ...
            onclick="gtag('event', 'ad_click', {
                ...
                ad_position: 'side',
                transport: 'beacon'
            });"><img src="https://res.cloudinary.com/ddozq3vu5/image/upload/w_160,h_600,c_pad,b_auto,f_auto,q_auto/v1776375124/Gemini_Generated_Image_x0r6v1x0r6v1x0r6_k89cxp.png" alt="Veed" width="160" height="600" style="object-fit: contain;" /></a>`
        }
    ]
};
